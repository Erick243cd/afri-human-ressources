...
<!-- Mirrored from preview.keenthemes.com/keen/demo3/authentication/general/error-500.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Oct 2022 05:18:44 GMT -->
...
<head>
	...
	<body id="kt_body" class="app-blank app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			<!--begin::Page bg image-->
			<style>body { background-image: url('../../assets/media/auth/bg11.jpg'); } [data-theme="dark"] body { background-image: url('../../assets/media/auth/bg11-dark.jpg'); }</style>
			<!--end::Page bg image-->
...
<!-- Mirrored from preview.keenthemes.com/keen/demo3/authentication/general/error-500.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Oct 2022 05:18:45 GMT -->
</html>